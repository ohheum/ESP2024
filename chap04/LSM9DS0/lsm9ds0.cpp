...
LSM9DS0::LSM9DS0(int bus, unsigned char gAddr, unsigned char xmAddr)
{
	...
	I2CBus = bus;  // by ohheum: 0, 1, or 2 since BBB has 2 I2C buses (0 and 1) and one additional
						...
						gyro_odr gODR, accel_odr aODR, mag_odr mODR)
{
	...
	unsigned char gTest = gReadByte(WHO_AM_I_G);		// Read the gyro WHO_AM_I register
...
void LSM9DS0::setGyroScale(gyro_scale gScl)
{
	...
	temp &= 0xFF^(0x3 << 4);    // 0xFF^(0x3<<4) = 11001111 so this just clears 2 bits (3rd and 4th significant bits)
